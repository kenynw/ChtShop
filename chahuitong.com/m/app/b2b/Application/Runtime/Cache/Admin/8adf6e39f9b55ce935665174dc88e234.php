...
<div class="admin_box">
<form action="<?php echo U('Admin/update_db');?>" method="post" id="myForm">
<input type="hidden" value="<?php echo ($data["id"]); ?>" name="id"/>
姓名:<input type="text" name="login_name" value="<?php echo ($data["login_name"]); ?>" id="login_name" maxlength="10"/>
<span id="login_nameTip"></span>
<br>
密码:<input type="password" value="<?php echo ($data["password"]); ?>" name="password" id="password" maxlength="20"/>
<span id="passwordTip"></span>
<br>
类型:
<select name="admin_type">
<?php if($data["admin_type"] == 2): ?><option value="2" selected="selected">普通管理员</option>
<option value="3">信息发布员</option>
<?php else: ?>
<option value="3" selected="selected">信息发布员</option>
<option value="2">普通管理员</option><?php endif; ?>
</select><br>
状态:
<select name="admin_status">
<?php if($data["admin_status"] == 1): ?><option value="1" selected="selected">启用</option>
