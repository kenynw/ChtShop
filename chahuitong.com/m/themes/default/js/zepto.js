...
;(function($){
	...
	$.fn.touchEventBind = function(touch_options)
	{
		var touchSettings = $.extend({
			tapDurationThreshold : 250,					//瑙﹀睆澶т簬杩欎釜鏃堕棿涓嶅綋浣渢ap
			scrollSupressionThreshold : 10,				//瑙﹀彂touchmove鐨勬晱鎰熷害
			swipeDurationThreshold : 250,				//澶т簬杩欎釜鏃堕棿涓嶅綋浣渟wipe
			horizontalDistanceThreshold: 130,			//swipe鐨勮Е鍙戝瀭鐩存柟鍚憁ove蹇呴』灏忎簬杩欎釜璺濈
			verticalDistanceThreshold: 15,				//swipe鐨勮Е鍙戞按骞虫柟鍚憁ove蹇呴』澶т簬杩欎釜璺濈
			tapHoldDurationThreshold: 750,				//swipe鐨勮Е鍙戞按骞虫柟鍚憁ove蹇呴』澶т簬杩欎釜璺濈
			doubleTapInterval: 250						//swipe鐨勮Е鍙戞按骞虫柟鍚憁ove蹇呴』澶т簬杩欎釜璺濈
		}, touch_options || {})
