...
<div class="admin_box">
<form action="<?php echo U('Customer/update_c_db');?>" method="post" id="myForm">
<input type="hidden" name="id" id="id" value="<?php echo ($data["id"]); ?>"/>
姓名:<input type="text" name="name" id="name" value="<?php echo ($data["name"]); ?>"/>
<span id="nameTip"></span>
<br>
电话:<input type="text" maxlength="11" name="telphone" id="telphone" value="<?php echo ($data["telphone"]); ?>"/>
<span id="telphoneTip"></span>
<br>
订单日期:<input type="text" name="deal_date" id="deal_date" onclick="WdatePicker()" value="<?php echo ($data["deal_date"]); ?>"/>
