$(function(){
	...
	function initPage(page,curpage){	
	   ...
	   var order_status=$("#order_status").val();	
		...
		$.ajax({
			...
			data:{key:key,order_state:order_status},
			dataType:'json',
    ...
    function viewOrderDelivery() {
        ...
        location.href = WapSiteUrl + '/index.php/Home/Index/wuliuapi?order_id=' + orderId;
    }
