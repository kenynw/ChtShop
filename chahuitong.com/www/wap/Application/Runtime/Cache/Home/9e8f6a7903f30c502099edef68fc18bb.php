                                ...
                                <div class="order-lcnt">
                                    ...
                                    <div class="order-shop-total">
                                        ...
                                        <p class="mt5">
                                            ...
                                            <a href="/wap/index.php/Home/Index/pingjiaorder/oid/<%=orderlist[j].order_id%>" order_id="<%=orderlist[j].order_id%>" class="sure-orders">评价商品</a>
                                            <%}%>
                                        </p>
                                    </div>
                                </div>
...
(function() {
  ...
  s.parentNode.insertBefore(hm, s);
    ...
    <script type="text/javascript" src="/wap/Public/Home/js/tmpl/order_list.js"></script>
     <script>
