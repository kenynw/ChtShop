...
<div class="page">
  ...
  <form id="user_form" enctype="multipart/form-data" method="post">
    ...
    <input type="hidden" name="guanzhu" value="<?php echo $output['member_array']['guanzhu'];?>" />
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
         ...
         <tr>
          <td colspan="2" class="required"><label for="guanzhu">关注度:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo $output['member_array']['guanzhu'];?>" id="guanzhu" name="guanzhu" class="txt"></td>
          <td class="vatop tips"></td>
        </tr>
         <tr>
          <td colspan="2" class="required"><label for="guanzhu">头衔:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo $output['member_array']['rank'];?>" id="rank" name="rank" class="txt"></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
