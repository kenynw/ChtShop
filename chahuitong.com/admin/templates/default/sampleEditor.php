...
<div class="page">
  ...
  <form id="post_form" method="post" name="form1" action="<?php echo urlAdmin('mb_sample_manage', 'sample_update'); ?>" enctype="multipart/form-data">
      ...
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform">
              <input name="sample_name" id="brand" value="<?php echo $output['sampleInfo']['sample_name']; ?>" class="txt" type="text">
          </td>
          <td class="vatop tips"></td>
        </tr>
        <tr class="smaple_img">
        ...
        <tr class="noborder smaple_img">
            <td class="vatop rowform">
                ...
                <input name="sample_image[]" id="year"  class="txt" type="file">
                <input name="sample_image[]" id="year"  class="txt" type="file">
                <input name="sample_image_hidden" id="" type="hidden" value="<?php echo $output['sampleInfo']['sample_image']; ?>">
                <input name="sample_id" id="" type="hidden" value="<?php echo $output['sampleInfo']['sample_id']; ?>">
            </td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
        ...
        <tr class="noborder">
            <td class="vatop rowform">
                <input name="sample_origin_place" id="year" value="<?php echo $output['sampleInfo']['sample_origin_place']; ?>" class="txt" type="text">
            </td>
          <td class="vatop tips"></td>
        </tr>
         <tr>
        ...
        <tr class="noborder">
            <td class="vatop rowform">
                <input name="sample_weight" id="" value="<?php echo $output['sampleInfo']['sample_weight']; ?>" class="txt" type="text">
            </td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
        ...
        <tr class="noborder">
            <td class="vatop rowform">
                <input name="sample_freight" id="" type="text" value="<?php echo $output['sampleInfo']['sample_freight']; ?>">
            </td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
        ...
        <tr class="noborder">
            <td class="vatop rowform">
                <input name="sample_limit_number" id="" type="text" value="<?php echo $output['sampleInfo']['sample_limit_number']; ?>">
            </td>
            <td class="vatop tips"></td>
        </tr>
        <tr>
        ...
        <tr class="noborder">
            <td class="vatop rowform">
                <input id="start_time" name="sample_start_time" id="" type="text" value="<?php echo date("Y-m-d H:i:s",$output['sampleInfo']['sample_start_time']); ?>">
            </td>
            <td class="vatop tips"></td>
        </tr>
        <tr>
        ...
        <tr class="noborder">
            <td class="vatop rowform">
                <input id="end_time" name="sample_end_time" id="" type="text" value="<?php echo date("Y-m-d H:i:s",$output['sampleInfo']['sample_end_time']); ?>">
            </td>
            <td class="vatop tips"></td>
        </tr>
        <tr>
            <td colspan="2" class="required"><label class="validation">链接:</label> </td>
        </tr>
        <tr class="noborder">
            <td class="vatop rowform">
                <input id="sample_link" name="sample_link" id="" type="text" value="<?php echo $output['sampleInfo']['sample_link']; ?>">
            </td>
            <td class="vatop tips"></td>
        </tr>
      </tbody>
        ...
        $.ajax({
            ...
            success:function(data){
                if(data.code==404){
                    ...
                    $("input[name='sample_link']").val("http://www.chahuitong.com/wap/index.php/Home/Index/goods?goods_id="+goods_id);
                    $(".smaple_img").hide();
                }
            }
