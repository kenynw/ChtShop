...
<div class="page">
  ...
  <form id="post_form" method="post" name="form1" action="<?php echo urlAdmin('mb_chashi', 'qutation_save');?>">
      ...
      <tbody>
        ...
        <tr>
            <td colspan="2" class="required"><label class="validation">产品链接:</label> </td>
        </tr>
        <tr class="noborder">
            <td class="vatop rowform">
                <input name="goods_link" id="year" value="" class="txt" type="text">
            </td>
            <td class="vatop tips"></td>
        </tr>
        <tr>
