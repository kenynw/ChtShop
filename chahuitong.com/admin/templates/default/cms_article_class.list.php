    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="w72 align-center"><a href="index.php?act=cms_article&op=cms_article_list&article_class_id=<?php echo $val['class_id'];?>">查看</a>&nbsp;&nbsp;<a href="javascript:submit_delete(<?php echo $val['class_id'];?>)"><?php echo $lang['nc_del'];?></a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
