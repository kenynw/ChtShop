...
>password   密码  
>code       验证码    
>client     客户端类型(android wap wechat ios)
...
返回： 

      {
          ...
          "data": {
              ...
              "key": "bb6a573583605063443c65f4395e559a"
          }
      }
...
### 第三方登录
URL: act=login&op=oauth  

参数：

>client 客户端类型，可选：android，ios，web   
>type   第三方类型，可选：sina,wechat,qq  
>openid 第三方授权返回的唯一标识,如微博登录的Uid，腾讯的openId    
>username 用户在第三方平台的用户名或者昵称
...

      {
          ...
          "data": {
              "key": {
                  "member_id": "5294",
                  "member_name": "DSK155",
                  "key": "60f1f1dd9856187e58abcdf85fc57182"
              }
          }
      }
...
返回:

    {
        ...
        "data": {
            "adv_list": [
                {
                    "image": "http://img.chahuitong.com/shop/common/default_goods_image_240.gif",
                    "type": "url",
                    "data": "http://www.chahuitong.com/example/web/raiders.html#"
                }
            ],
            "home3": [
                {
                    "image": "http://img.chahuitong.com/shop/common/default_goods_image_240.gif",
                    "type": "url",
                    "data": "goodsList://m.chahuitong.com/commend"
                }
            ],
            "home1": {
                "title": "试茶师推荐",
            ...
            "home4": {
                "title": "",
                "rectangle1_image": "http://img.chahuitong.com/shop/common/default_goods_image_240.gif",
                "rectangle1_type": "url",
                "rectangle1_data": "http://www.chahuitong.com/wap/index.php/Home/index/categorydetail/id/1",
                "rectangle2_image": "http://img.chahuitong.com/shop/common/default_goods_image_240.gif",
                "rectangle2_type": "url",
                "rectangle2_data": "http://www.chahuitong.com/wap/index.php/Home/index/product_list?keyword=新品",
                "square_image": "http://img.chahuitong.com/shop/common/default_goods_image_240.gif",
                "square_type": "url",
                "square_data": "http://www.chahuitong.com/wap/index.php/Home/index/product_list?keyword=尊享"
            },
            "home2": {
                "title": "",
                "square_image": "http://img.chahuitong.com/shop/common/default_goods_image_240.gif",
                "square_type": "url",
                "square_data": "http://www.chahuitong.com/wap/index.php/Home/Index/brandGoods/bid/375",
                "rectangle1_image": "http://img.chahuitong.com/shop/common/default_goods_image_240.gif",
                "rectangle1_type": "url",
                "rectangle1_data": "http://www.chahuitong.com/wap/index.php/Home/index/product_list?keyword=%E7%89%B9%E5%8D%96",
                "rectangle2_image": "http://img.chahuitong.com/shop/common/default_goods_image_240.gif",
                "rectangle2_type": "url",
                "rectangle2_data": "http://www.chahuitong.com/wap/index.php/Home/index/product_list?keyword=精品"
            },
            "guess_list": [
                {
                    "goods_id": "101302",
                    "goods_name": "寸心草 恋菁绿茶500精装 150g",
                    "goods_price": "150.00",
                    "goods_image": "2_04896916816277567.jpg",
                    "goods_image_url": "http://img.chahuitong.com/shop/common/default_goods_image_360.gif",
                    "origin": "贵州"
                }
            ]
        }
...
### ~~限时抢购今日~~<已被act=goods_xianshi&op=current_list替换>
            ...
            "list": [
                {
                    ...
                    "xianshi_name": "双十一特价",
                    "xianshi_title": "双十一特价",
                    "xianshi_explain": "双十一特惠 ，好喝又不贵。",
                    "goods_id": "101356",
                    "store_id": "2",
                    "goods_name": "滇臻號 “滇系列”熟茶 来自布朗山 357g",
                    "goods_price": "380.00",
                    "xianshi_price": "380.00",
                    "goods_image": "2_04988369896060552.jpg",
                    "start_time": "1446998400",
                    "end_time": "1548812800",
                    "lower_limit": "1",
                    "state": "1",
                    "xianshi_recommend": "0",
...
URL: act=login&op=forget_password  
...
### 发送身份验证短信验证码（用于绑定手机、邮箱等）

URL: act=member_security&op=send_auth_code 
...
URL: act=member_security&op=modify_pwd
...
### 移动到收藏夹
URL: act=member_cart&op=move_favorites  

参数：

>key 登录令牌    
>cart_id 购物车编号 如果是多个用逗号隔开     
...
>key 当前登录令牌        
>mid 用户ID 指定某个用户的ID,如果不传则会返回当前登录用户的 
...
URL: act=member_sns_inform&op=inform_trace
...
URL: act=member_sns_inform&op=inform_home
...
URL: act=member_sns_home&op=trace_list

参数：

>key 登录令牌,查看自己的动态列表    
>commend 是否为精选动态 传1为是 其他不传或传0  
...
### 好友动态列表
URL: act=member_sns_friend&op=trace_list
...
返回：

    {
        ...
        "data": {
            "ad_list": [
                {
                    "link_pic": "adbbb2e550645d098d3e4ab92226de2a.jpg",
                    "link_keyword": "百货",
                    "link_pic_url": "http://img.chahuitong.com/mobile/ad/adbbb2e550645d098d3e4ab92226de2a.jpg"
                }
            ],
            "trace_list": [
                {
            ...
            "list": [
                {
                    ...
                    "fav_id": "54",
                    "fav_type": "flea",
                    "fav_time": "2016.07.26 18:26",
                    "goods_id": "54",
                    "goods_name": "祁门红茶 祁红香螺",
                    "goods_image": "http://img.chahuitong.com/shop/common/default_goods_image_240.gif",
                    "goods_store_price": "320.00",
                    "goods_abstract": "祁红香螺高山茶，手工制作！[强][强][强]制作工艺：萎凋-揉捻-发酵-铁锅手工成形"
                }
            ],
            "hasmore": false,
            "page_total": 1
...
返回：

    {
        ...
        "msg": "SUCCESS",
        "data": {
            "version": "1.2.2" // 服务端最新版本号
            "url": // 安装包下载地址
            "if_update": true // 是否需要更新
            "info": // 更新内容
        }
    }
