...
class c_index extends Admin{
    ...
    function index($path){
		...
		<li>隐私保护: <span class="note2">'.APP_NAME.'[免费版] 郑重承诺, 您在使用本系统时, WeLive开发商不会收集您的任何信息</span>.</li>
		<li>您在使用 '.APP_NAME.'[免费版] 时有任何问题, 请访问: <a href="http://www.weentech.com/bbs/" target="_blank">闻泰网络BBS</a>!</li></ul>';
