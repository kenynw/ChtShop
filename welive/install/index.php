...
$footer = '</div>
<div id="copyright">
	'.date("Y").' &copy; WeLive('. $WeLiveVersion .') <a href="http://www.weentech.com" target="_blank">weentech.com</a>
</div>
</body>
</html>';
...
if(defined('SYSDIR')){
	...
	关于服务器是否或如何支持Socket扩展功能，请咨询您的服务器提供商。<BR><BR>';
...
if(isset($_POST['install'])){
	...
	if(function_exists('mysql_connect')){
		...
		if($connection = @MYSQL_CONNECT($servername, $dbusername, $dbpassword)){
			...
			if($sqlversion >= '5.0') mysql_query("SET sql_mode=''");
