        ...
        if (in_array('order_goods',$extend)) {
            ...
            if (!empty($order_goods_list)) {
                foreach ($order_goods_list as $value) {
                    $brand = Model('brand')->getBrandJoinGoods(array('goods.goods_id'=>$value['goods_id']),'brand.*');
                    $value['brand_id'] = $brand && is_array($brand) && isset($brand['brand_id']) ? $brand['brand_id'] : '';
                    $value['brand_name'] = $brand && is_array($brand) && isset($brand['brand_name']) ? $brand['brand_name'] : '';
