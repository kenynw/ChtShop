...
class memberModel extends Model {
    ...
    public function register($register_info) {
        ...
        if(isset($_POST['openid'])){
            if($_POST['op']=='qq'){
                $member_info['member_qqopenid']=$register_info['member_qqopenid'];
            }
            if($_POST['op']=='sina'){
                $member_info['member_sinaopenid']=$register_info['member_sinaopenid'];
            }
            if($_POST['op']=='wechat'){
                $member_info['member_wechatopenid']=$register_info['member_wechatopenid'];
            }
