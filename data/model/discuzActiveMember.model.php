...
class discuzActiveMemberModel extends Model {
    //开启状态标识
    const STATE_OPEN = 1;

    public function __construct(){
		
        parent::__construct('discuz_active_member');
    ...
    public function getActiveList($condition, $field = '*', $page = 0, $order = 'active_id desc', $limit = ''){
