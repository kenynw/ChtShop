...
class brandModel extends Model {
     ...
     * @return mixed
     */
    public function getBrandJoinGoods($condition, $field = '*'){
        return $this->table('brand,goods')->join('inner')->on('brand.brand_id=goods.brand_id')->where($condition)->field($field)->find();
    }
