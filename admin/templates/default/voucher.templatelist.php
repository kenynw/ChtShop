...
<?php } ?>
            ...
            <?php } ?></td>
            <td class="nowrap align-center"><a href="index.php?act=voucher&op=templateedit&tid=<?php echo $val['voucher_t_id'];?>"><?php echo $lang['nc_edit'];?></a>|<a href="index.php?act=voucher&op=template_give&tid=<?php echo $val['voucher_t_id'];?>&value=<?php $value=($val['voucher_t_register_give']==0)?1:0;echo $value; ?>"><?php $value=($val['voucher_t_register_give']==1)?"关闭":"注册送";echo $value; ?></a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
