...
<div class="page">
  ...
  <form id="post_form" method="post" name="form1" action="<?php echo urlAdmin('mb_shequ', 'shequ_save');?>" enctype="multipart/form-data" >
       ...
       <tr>
        ...
        <tr class="noborder">
            <td class="vatop rowform">
                ...
                <input name="image6"  class="image06" type="file">
            </td>
          <td class="vatop tips"></td>
        </tr>   
