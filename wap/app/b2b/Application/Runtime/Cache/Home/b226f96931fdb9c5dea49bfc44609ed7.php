...
<style>.picimg{width:100%;max-height:84px;}</style>
...
$(document).ready(function() {
	...
	$(".click").click(function(){
		...
		window.location.href="/mobile/app/b2b/index.php/Home/Index/sale/order/1";
...
<div class="mail">
<div class="nav">
<a class="all" href="/mobile/app/b2b/index.php/Home/Index/index">全部</a>
<a class="sale" href="/mobile/app/b2b/index.php/Home/Index/sale" style="margin: 1px 1px;
padding: 2px 0px 9px 0px;
background: #fff;
color: #a15641;
border-left: 1px solid #a15641;
border-top: 1px solid #a15641;
border-right: 1px solid #a15641;background:url(http://www.chahuitong.com/mobile/app/b2b/public/Home/img/dian.png) no-repeat 85% 30%;background-size:15% 50%">出售</a>
<a class="buy" href="/mobile/app/b2b/index.php/Home/Index/buy">求购</a>
...
<div class="state">
<img src="/mobile/app/b2b/Public/Home/img/shou.png">
</div>
</div>
<div class="shop">
<div class="title">
<h3><?php echo ($v["name"]); ?></h3>
<p><span>年份：<?php echo ($v["year"]); ?></span><span>数量：<?php echo ($v["number"]); ?>饼</span></p>
